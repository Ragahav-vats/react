...
const sortOptions = [
    ...
    { name: 'Price: Discounted Low to High', value: '5', current: false },
    { name: 'Price: Discounted High to Low', value: '6', current: false },
    { name: 'Price: Rating Low to High', value: '7', current: false },
    { name: 'Price: Rating High to Low', value: '8', current: false },
]
const subCategories = [
    { name: 'Totes', href: '#' },
    { name: 'Backpacks', href: '#' },
                                ...
                                <form className="hidden lg:block">
                                  <Disclosure as="div" className="border-b border-gray-200 py-6">
                                        ...
                                        <Disclosure as="div" className="border-b border-gray-200 py-6">
                                            ...
                                            <DisclosurePanel className="pt-6">
                                                <div className="space-y-4">
                                                    ...
                                                    <div key={optionIdx} class="flex items-center gap-x-3">
                                                        <input id={option.from} onClick={()=>price(option.from,option.to)} type="radio" name="price-filter" class="relative size-4 appearance-none rounded-full border border-gray-300 bg-white before:absolute before:inset-1 before:rounded-full before:bg-white not-checked:before:hidden checked:border-indigo-600 checked:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:before:bg-gray-400 forced-colors:appearance-auto forced-colors:before:hidden" />
                                                        <label for={option.from} class="block text-sm/6 font-medium text-gray-900">{option.name}</label>
                                                    </div>                                        
                                                    ))}
                                                </div>
                                        ...
                                        <Disclosure as="div" className="border-b border-gray-200 py-6">
                                            ...
                                            <DisclosurePanel className="pt-6">
                                                <div className="space-y-4">
                                                    {discountedRange.map((option, optionIdx) => (
                                                        
                                                    <div key={optionIdx} class="flex items-center gap-x-3">
                                                        <input id={option.from} onClick={()=>discounted(option.from,option.to)} type="radio" name="discounted-filter" class="relative size-4 appearance-none rounded-full border border-gray-300 bg-white before:absolute before:inset-1 before:rounded-full before:bg-white not-checked:before:hidden checked:border-indigo-600 checked:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:before:bg-gray-400 forced-colors:appearance-auto forced-colors:before:hidden" />
                                                        <label for={option.from} class="block text-sm/6 font-medium text-gray-900">{option.name}</label>
                                                    </div>                                        
                                                    ))}
                                                </div>
                                        ...
                                        <Disclosure as="div" className="border-b border-gray-200 py-6">
                                            ...
                                            <DisclosurePanel className="pt-6">
                                                <div className="space-y-4">
                                                    {ratingRange.map((option, optionIdx) => (
                                                        
                                                    <div key={optionIdx} class="flex items-center gap-x-3">
                                                        <input id={option.from} onClick={()=>ratingFilter(option.value)} type="radio" name="rating-filter" class="relative size-4 appearance-none rounded-full border border-gray-300 bg-white before:absolute before:inset-1 before:rounded-full before:bg-white not-checked:before:hidden checked:border-indigo-600 checked:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:before:bg-gray-400 forced-colors:appearance-auto forced-colors:before:hidden" />
                                                        <label for={option.from} class="block text-sm/6 font-medium text-gray-900">{option.name}</label>
                                                    </div>                                        
                                                    ))}
                                                </div>
